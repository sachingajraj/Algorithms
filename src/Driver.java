public class Driver {
	...
	public static void main(String[] args) {
		...
		/*
		 * int[] arr = {5,2,1,3,4}; SortQuestions s = new SortQuestions(arr);
		 * s.quicksort(); s.printArray();
		 */
		...
		/*
		 * ArrayQuestions aq = new ArrayQuestions(); int[] arr =
		 * {2,1,0,0,2,1,0,1,1}; int[] res = aq.sort012(arr); for (int i :res){
		 * System.out.print(i + " "); }
		 */
